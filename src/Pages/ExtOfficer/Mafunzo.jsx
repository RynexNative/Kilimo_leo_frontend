...
import AddResourceModal from '../../components/ExtOfficer/AddResourceModal'
  ...
  <div className={styles.container}>
   ...
   <div className={styles.filters}>
    ...
    >
     ...
     {/* #Add resource Button */}
    <button onClick={()=>setShowModal(true)}>+Ongeza Mafunzo</button>
   </div>
   ...
   {/* #Add Resource Modal */}
   <AddResourceModal isOpen={showModal} onClose={setShowModal}/>
  </div>
 );
}
